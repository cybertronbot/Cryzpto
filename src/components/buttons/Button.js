const getVariant = variant => {
    switch (variant) {
      case "primary":
        return "bg-[#141414] hover:bg-black text-white shadow shadow-black-600/25 hover:shadow-black-600/75"
      case "secondary":
        return "bg-[#F7512E] hover:bg-black text-white shadow shadow-black-600/25 hover:shadow-black-600/75"
